      ...
      <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
       ...
       <span className="ms-1 dashboard-logout-btn d-none d-sm-inline">My Profile</span>
          ...
          <li>
            ...
            <span className="ms-1 dashboard-logout-btn d-none d-sm-inline">All users</span> </Link>
          </li>
        </ul>
        <hr />
        <div className=" pb-4">
        <div class="button"><button onClick={handleLogout} class="btn">Logout<span class="dir-part"></span></button></div>
